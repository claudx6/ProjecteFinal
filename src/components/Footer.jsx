...
const Footer = () => {
    const handleFacebookClick = () => {
        window.location.href = "https://m.facebook.com/Petit-Amazones-379384915771965/?locale=es_LA";
    };
    ...
    return (
        <div className='footer'>
            ...
            <div className="footerLinks">
                ...
                <FontAwesomeIcon icon={faFacebook} className='icon' onClick={handleFacebookClick}/>
                </div>
            </div>
